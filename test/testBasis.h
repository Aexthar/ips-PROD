...
#include <armadillo>
#include "../dev/hdr/basis.h"
#include "../dev/hdr/constants.h"
...
class TestBasis : public CxxTest::TestSuite
{
    public:
        void testRPart( void )
        {
            ...
            TS_ASSERT_DELTA(arma::norm(basis.calcR(0,0) - res00), 0.0, 1e-15);
            ...
            TS_ASSERT_DELTA(arma::norm(basis.calcR(8, 2) - res82), 0.0, 1e-15);
        }
        ...
        void testZPart( void )
        {
            ...
            TS_ASSERT_DELTA(arma::norm(basis.calcZ(0) - res00), 0.0, 1e-15);
            ...
            TS_ASSERT_DELTA(arma::norm(basis.calcZ(15) - res15), 0.0, 1e-15);
        }
};